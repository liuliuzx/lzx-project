package com.lzx.admin.service.entity.model.base;
...
public abstract class BaseRes<M extends BaseRes<M>> extends JbootModel<M> implements IBean {
	...
	public void setComponentRouter(java.lang.String componentRouter) {
		set("componentRouter", componentRouter);
	}
	
	public java.lang.String getComponentRouter() {
		return getStr("componentRouter");
	}
